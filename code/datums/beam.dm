...
// Our collection of ebeam subtypes
...
/obj/effect/ebeam/reacting/vine/on_entered(datum/source, atom/movable/arrived, atom/old_loc, list/atom/old_locs)
	. = ..()
	if(!isliving(arrived))
		return
...
/obj/effect/ebeam/reacting/deadly/on_entered(datum/source, atom/movable/arrived, atom/old_loc, list/atom/old_locs)
	arrived.ex_act(EXPLODE_DEVASTATE)

/obj/effect/ebeam/reacting/disintegration

/obj/effect/ebeam/reacting/disintegration/on_entered(datum/source, atom/movable/arrived, atom/old_loc, list/atom/old_locs)
	if(!isliving(arrived))
		return
	var/mob/living/entered = arrived
	var/damage = 50
